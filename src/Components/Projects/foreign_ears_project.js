  ...
  () => (
    <div className="project-item-container">
      ...
      <div className="project-item">
        ...
        <div className="project-description-container project-one-description-container" >
          <div className='project-one-description-container'>
            ...
            <p>This app was written in React Native and is supported with a complete serverless backend hosted on AWS.
              <br/>Data is managed using Redux, Redux Saga and Redux persist which is then persisted in the backend to dynamoDB.</p>
